...
const STOCK_KIND_LABELS: Record<string, string> = { current: "фактический", estimated: "оценка", override: "задан вручную", unknown: "нет данных, принят 0" };
