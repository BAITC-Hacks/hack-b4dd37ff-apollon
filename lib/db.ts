...
export function getDb(): PrismaClient {
  ...
  if (!productionRelay && !host.endsWith(".railway.internal") && !host.endsWith(".proxy.rlwy.net")) {
    throw new Error("Only Railway PostgreSQL is supported. Use scripts/with-production-db.ts for local development.");
  }
