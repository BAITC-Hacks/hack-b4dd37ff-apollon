...
export const metadata: Metadata = { title: "EKT SupplyAI — расчёт заказов поставщикам", description: "Объяснимый расчёт закупок IEK и Systeme Electric: спрос, остатки, поставки и утверждение заказа." };
