...
export async function GET(request: Request) {
  try {
    ...
    const page = await listStockHistory({ datasetId, supplier: url.searchParams.get("supplier") || undefined, search: url.searchParams.get("q") || undefined }, parsePageParam(url.searchParams.get("page")), parsePageSizeParam(url.searchParams.get("pageSize")));
