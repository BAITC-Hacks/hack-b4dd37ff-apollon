...
import { api, EmptyState, ErrorNotice, LoadingState, PageHeading, supplierLabel, useWorkspace } from "./workspace";
...
export function TrendsDashboard() {
  ...
  return <>
    ...
    {!datasetId ? <EmptyState /> : loading ? <LoadingState text="Строим динамику…" /> : rows.length === 0 ? <div className="empty-state"><h2>Нет данных о продажах</h2><p>В наборе «{dataset?.name}» не найдено помесячных продаж для построения тренда.</p></div> : <>
